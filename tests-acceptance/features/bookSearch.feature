Feature: Como um petiano
         I want to pesquisar por livros do meu interesse
         So that encontrar o livro de meu interesse de forma mais rápida

Scenario: Pesquisa por nome com o livro cadastrado
...
Scenario: Pesquisa por nome com filtro de tópico com o livro cadastrado
...
Scenario: Pesquisa por nome e por autor com o livro cadastrado
...
Scenario: Pesquisa por nome, por autor e por filtro com o livro cadastrado
